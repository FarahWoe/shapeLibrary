...
namespace Bif3.Swe1.Oop {
    class Program {
        static void Main(string[] args) {
            ...
            //is of type baseclass but of value derived class
            ...
            //new -> if object of type baseclass, then methods in derived class with new are ignored.
            bcdc.Method2();
            ...
            //type AbstractShape is not possible
            ...
            //AbstractShape shape = new DerivedLine(0, 3, 5, 8);
            //DerivedCircle line3 = (DerivedCircle)shape;
            Console.WriteLine("-----");
            ...
            Console.WriteLine("-----" +betterCompound.GetArea());
